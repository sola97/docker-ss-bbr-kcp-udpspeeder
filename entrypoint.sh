...
TINY_MAPPER_MODULE="tinymapper"
TINY_MAPPER_CONFIG_ONE=${TINY_MAPPER_CONFIG_ONE:-""}
TINY_MAPPER_CONFIG_TWO=${TINY_MAPPER_CONFIG_TWO:-""}
...
while getopts "S:s:K:k:u:t:T:b:B:m:M:" OPT; do
    case $OPT in
        S)
            SS_CONFIG=$OPTARG;;
        s)
        ...
        B)
            BBR_CONFIG=$OPTARG;;
        m)
            TINY_MAPPER_CONFIG_ONE=$OPTARG;;
        M)
            TINY_MAPPER_CONFIG_TWO=$OPTARG;;
    esac
done
...
export TINY_MAPPER_MODULE=${TINY_MAPPER_MODULE}
export TINY_MAPPER_CONFIG_ONE=${TINY_MAPPER_CONFIG_ONE}
export TINY_MAPPER_CONFIG_TWO=${TINY_MAPPER_CONFIG_TWO}
